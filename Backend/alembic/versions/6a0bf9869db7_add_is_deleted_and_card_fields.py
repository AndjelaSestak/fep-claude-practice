...
def upgrade() -> None:
    ...
    op.add_column(
        "email_verifications", sa.Column("card_id", sa.Integer(), nullable=True)
    )
    op.create_foreign_key(
        "fk_email_verifications_card_id",
        "email_verifications",
        "cards",
        ["card_id"],
        ["id"],
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "fk_email_verifications_card_id", "email_verifications", type_="foreignkey"
    )

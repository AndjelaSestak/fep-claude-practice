...
def upgrade() -> None:
    ...
    sa.Column('purpose', sa.Enum('registration', 'password_reset', 'card_verification', 'card_report', name='verificationpurpose'), nullable=False),
    ...
    sa.Column('status', sa.Enum('active', 'blocked', 'expired', 'reported_lost', 'reported_stolen', name='cardstatus'), nullable=False),
    sa.Column('is_email_verified', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('report_type', sa.Enum('lost', 'stolen', 'manual_block', 'admin_block', name='reporttype'), nullable=False),
    ...
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['transaction_template_id'], ['transaction_templates.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('card_id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('reccuring', 'single', name='transactiontype'), nullable=False),
    sa.Column('amount', sa.Numeric(precision=12, scale=2), nullable=False),
    sa.Column('currency', sa.String(length=3), nullable=False),
    sa.Column('recipient', sa.Text(), nullable=True),

  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div
        role="alertdialog"
        aria-modal="true"
        className={cn('bg-white rounded-xl shadow-xl w-full max-w-lg p-6 relative', className)}
      >
        {children}
...
export function AlertDialogAction({ onClick, children, className, ...props }) {
  return (
    <Button variant="default" onClick={onClick} className={className} {...props}>
      {children}
    </Button>
  )
}
...
export function AlertDialogCancel({ onClick, children, className, ...props }) {
  return (
    <Button variant="outline" onClick={onClick} className={className} {...props}>
      {children}
    </Button>
  )
}

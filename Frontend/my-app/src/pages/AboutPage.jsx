        ...
        <section className="px-16 py-12 flex gap-16 items-start max-w-6xl mx-auto">
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <p className="text-gray-600">
              ...
              complicated, too expensive, and too inaccessible for millions of people around the
              world.
            </p>
            <p className="text-gray-600">
              Our founders, a team of fintech veterans and security experts, set out to create a
              banking platform that would put users first—combining cutting-edge technology with
              bank-grade security and an intuitive user experience.
            </p>
            <p className="text-gray-600">
            ...
            <p className="text-primary font-medium">
              This is an educational platform demonstrating modern banking features and best
              practices.
            </p>
          </div>
        ...
        <section className="px-16 py-12 max-w-6xl mx-auto">
          <div className="bg-primary-light rounded-2xl p-12 text-center">
            ...
            <p className="text-gray-600 mt-4 max-w-3xl mx-auto">
              SecureBank is designed as an educational platform to demonstrate modern banking
              features, security best practices, and user experience design. This platform showcases
              how a comprehensive banking application should be structured, from user authentication
              and transaction management to admin oversight and security protocols.
            </p>
          </div>
        </section>
      </main>

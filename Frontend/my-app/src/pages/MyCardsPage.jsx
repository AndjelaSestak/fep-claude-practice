    ...
    <div className="flex h-screen bg-slate-100">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-8">
          ...
          {/* HEADER */}
          <header className="relative bg-primary/10 p-8 rounded-[2.5rem] border border-primary/20 flex flex-col md:flex-row md:items-center justify-between gap-6 overflow-hidden mb-6">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-[11px] font-black text-primary-dark uppercase tracking-[0.2em]">Your Cards</span>
              </div>

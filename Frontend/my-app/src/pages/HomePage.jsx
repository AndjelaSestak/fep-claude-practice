    ...
    <div>
      ...
      <section className="bg-primary-light flex flex-col items-center justify-center text-center px-8 py-24">
        ...
        <p className="text-gray-500 mt-6 max-w-xl text-lg">
          Experience the future of banking with SecureBank. Manage your finances, track expenses,
          and make payments—all from one secure platform.
        </p>
      ...
      <section className="px-8 py-16 bg-gray-50">
        ...
        <div className="grid grid-cols-3 gap-6 max-w-6xl mx-auto">
          {features.map(({ icon, title, desc, featured }) => (
            <div
              key={title}

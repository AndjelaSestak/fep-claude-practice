        ...
        <section className="bg-primary-light px-8 py-24 text-center">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg text-gray-500">
              We&apos;re a diverse team of banking experts, engineers, designers, and customer
              advocates united by a shared mission to transform the banking experience.
            </p>
          </div>
        </section>
            ...
            <div className="mt-14 grid gap-8 xl:grid-cols-2">
              <TeamCard hover>
                ...
                <p className="mt-6 text-base leading-7 text-slate-500">
                  A confident and outspoken leader with outstanding organizational abilities and
                  strong development expertise built from an early start in high school, further
                  refined through academic experience at university in the capital.
                </p>
              </TeamCard>
              ...
              <TeamCard hover>
                ...
                <p className="mt-6 text-base leading-7 text-slate-500">
                  A highly adaptable developer with a keen eye for detail, known for deep, in-depth
                  work and playing a key role in maintaining team balance and cohesion.
                </p>
              </TeamCard>
              ...
              <TeamCard hover>
                ...
                <p className="mt-6 text-base leading-7 text-slate-500">
                  A highly efficient, reliable developer and an ideal teammate, whose experience in
                  the gaming industry was instrumental in designing this platform.
                </p>
              </TeamCard>
              ...
              <TeamCard hover>
                ...
                <p className="mt-6 text-base leading-7 text-slate-500">
                  A dedicated and versatile developer with a strong focus on building
                  well-structured solutions, while fostering a positive team atmosphere and keeping
                  morale high.
                </p>
              </TeamCard>
              ...
              <div className="xl:col-span-2 flex justify-center">
                <div className="xl:w-1/2">
                  <TeamCard hover>
                    ...
                    <p className="mt-6 text-base leading-7 text-slate-500">
                      A passionate machine learning engineer with a strong analytical mindset,
                      bringing data-driven insights and intelligent solutions to the platform while
                      bridging the gap between engineering and innovation.
                    </p>
                  </TeamCard>
                </div>
              </div>
